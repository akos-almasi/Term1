...
I created 5 sql files (data folder) from the original csvs and loaded them into the created tables in the following order: circuits, drivers, races, constructors, raceresults
